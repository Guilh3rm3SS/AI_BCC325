...
class NimAI():
    ...
    def best_future_reward(self, state):
        ...
        for action in possible_actions:
            if (tuple(state), action) in self.q:
                if self.q[(tuple(state), action)] > best_future_reward:
                    best_future_reward = self.q[(tuple(state), action)]
    ...
    def choose_action(self, state, epsilon=True):
        ...
        if best_action is None:
            best_action = random.choice(list(possible_actions))  # Fallback to random action
